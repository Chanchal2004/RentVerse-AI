"""Modular storage abstraction. Default: Emergent Object Storage.
Swap to Cloudinary/S3 by implementing the same interface and setting STORAGE_BACKEND env."""
import os
import uuid
import logging
import requests
...
APP_NAME = os.environ.get("APP_NAME", "rentalplatform")
